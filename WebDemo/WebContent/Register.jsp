...
<table align="right" cellspacing="2">
	<tr bgcolor="gray"><td colspan="2"><center><h2><font face="monotype corsiva" color="blue" size="10">Sign Up Here</font></h2></center></td></tr>
	<tr bgcolor="gray"><td colspan="2"><center><h2><font face="monotype corsiva" color="red" size="10">${errorInfo}</font></h2></center></td></tr>
	<tr>
